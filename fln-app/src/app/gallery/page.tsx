...
const galleryImages = [
  ...
  { src: '/imgs/WA-20250806-152131-0a3f.jpg', title: 'FLN President mentoring and motivating parents at Gayaza High School.', description: '', category: 'events' },
  { src: '/imgs/WA-20250806-152131-1185.jpg', title: '', description: '', category: 'events' },
  ...
  { src: 'imgs/FlnUpdate29-4-26/1750961988408.jpg', title: 'FEMALE LAWYERS GIRLS EMPOWERENT', description: '', category: 'events' },
  { src: 'imgs/FlnUpdate29-4-26/1750961988654.jpg', title: '', description: '', category: 'events' },
  { src: 'imgs/FlnUpdate29-4-26/1750962007567.jpg', title: '', description: '', category: 'events' },

  { src: 'imgs/FlnUpdate29-4-26/1752549186983.jpg', title: 'FLN Mentorship Session at Muwema & Co Advocates', description: '', category: 'workshops' },
  { src: 'imgs/FlnUpdate29-4-26/1753200947402.jpg', title: '', description: '', category: 'workshops' },

  { src: 'imgs/FlnUpdate29-4-26/1750852241061.jpg', title: 'FLN partnership with The Empathy Whale at Zion Advocates', description: 'We held an interactive session and also shared seedlings to push the climate change agenda even further', category: 'events' },
  { src: 'imgs/FlnUpdate29-4-26/1750852228412.jpg', title: '', description: '', category: 'events' },
  { src: 'imgs/FlnUpdate29-4-26/1755025517880.jpg', title: '', description: '', category: 'events' },

  { src: 'imgs/FlnUpdate29-4-26/1753124778837.jpg', title: 'Global Fund For Women', description: '', category: 'workshops' },
  { src: 'imgs/FlnUpdate29-4-26/1753124777985.jpg', title: '', description: '', category: 'workshops' },

  { src: 'imgs/FlnUpdate29-4-26/1760880141304.jpg', title: '', description: '', category: 'events' },
  { src: 'imgs/FlnUpdate29-4-26/1760880139460.jpg', title: '', description: '', category: 'events' },
  { src: 'imgs/FlnUpdate29-4-26/1760880139682.jpg', title: '', description: '', category: 'events' },

  { src: 'imgs/FlnUpdate29-4-26/1761121137115.jpg', title: 'FLN Market Drive', description: '', category: 'events' },
  { src: 'imgs/FlnUpdate29-4-26/1761121129957.jpg', title: '', description: '', category: 'events' },
  { src: 'imgs/FlnUpdate29-4-26/1761121135623.jpg', title: '', description: '', category: 'events' },

  { src: 'imgs/FlnUpdate29-4-26/1766391920488.jpg', title: 'FLN Workshop on Climate Change', description: '', category: 'workshops' },
  { src: 'imgs/FlnUpdate29-4-26/1766391922773.jpg', title: '', description: '', category: 'workshops' },

  { src: 'imgs/FlnUpdate29-4-26/1762585557380.jpg', title: 'FLN IUIU-Rule of LAW-Leadership Summit', description: '', category: 'events' },
  { src: 'imgs/FlnUpdate29-4-26/1762585933677.jpg', title: '', description: '', category: 'events' },
  { src: 'imgs/FlnUpdate29-4-26/1762585937896.jpg', title: '', description: '', category: 'events' },

  { src: 'imgs/FlnUpdate29-4-26/1772045454239.jpg', title: 'FLN Community Climate Change Drive', description: '', category: 'events' },
  { src: 'imgs/FlnUpdate29-4-26/1772045453401.jpg', title: '', description: '', category: 'events' },

  { src: 'imgs/FlnUpdate29-4-26/1775136915904.jpg', title: '', description: '', category: 'conferences' },
  { src: 'imgs/FlnUpdate29-4-26/1775136915948.jpg', title: '', description: '', category: 'conferences' },
                  
  { src: 'imgs/FlnUpdate29-4-26/1773498040652.jpg', title: 'UWA Womens Day', description: 'FLN president Dr.Joyce Nalunga was invited to the Ka-Chai FireSide chat where she engaged with women for meaningful and powerful conversations.', category: 'events' },
  { src: 'imgs/FlnUpdate29-4-26/1773498037182.jpg', title: '', description: '', category: 'events' },
                    
  { src: 'imgs/FlnUpdate29-4-26/1760341181965.jpg', title: 'Women in Electoral Governance', description: 'We held the FLN symposium on 26th September 2025 at the Hotel Africana', category: 'conferences' },
  { src: 'imgs/FlnUpdate29-4-26/1759143592211.jpg', title: '', description: '', category: 'conferences' },
  { src: 'imgs/FlnUpdate29-4-26/1759143590074.jpg', title: '', description: '', category: 'conferences' },
  { src: 'imgs/FlnUpdate29-4-26/1759143590347.jpg', title: '', description: '', category: 'conferences' },
  { src: 'imgs/FlnUpdate29-4-26/1758953788099.jpg', title: '', description: '', category: 'conferences' },

  { src: 'imgs/FlnUpdate29-4-26/1763636823152.jpg', title: 'Inter-University Leadership Conference', description: 'We held an electric conference at National ICT hub in Nakawa where we engaged the youth on strategic leadership including purposeful living,mental strength and meaningful relationships.', category: 'conferences' },
  { src: 'imgs/FlnUpdate29-4-26/1763800068257.jpg', title: '', description: '', category: 'conferences' },
  { src: 'imgs/FlnUpdate29-4-26/1763808920991.jpg', title: '', description: '', category: 'conferences' },
  { src: 'imgs/FlnUpdate29-4-26/1763810405121.jpg', title: '', description: '', category: 'conferences' },

  { src: 'imgs/FlnUpdate29-4-26/1774363722331.jpg', title: 'FISHERWOMEN AND CLIMATE CHANGE CRISIS', description: 'Are you aware ? Rising water levels, unpredictable weather patterns, and declining fish stocks disproportionately affect their economic stability and food security.By equipping women with knowledge on climate adaptation, sustainable practices, and environmental stewardship, we strengthen not only their resilience but also that of entire communities.', category: 'events' },
  ...
  { src: 'imgs/FlnUpdate25-8-26/WhatsApp Image 2026-08-24 at 09.54.58.jpeg', title: ' FLN held a climaye change workshop for female lawyers with the topic Climate Change and Women', description: "Climate change, women and technology are deeply interconnected. Women and girls are often among those most affected by climate change, yet they are also powerful agents of resilience, innovation and transformation.", category: 'workshops' },
  ...
  { src: 'imgs/FlnUpdate25-8-26/WhatsApp Image 2026-08-27 at 15.06.40.jpeg', title: 'Developing climate resilience and adaptability', description: "FLN's Gender Advisor Lavendar  Nassanga training girls on how to develop climate resilience and adaptability in a fast changing world", category: 'workshops' },
  { src: 'imgs/FlnUpdate25-8-26/WhatsApp Image 2026-08-27 at 15.06.40 (1).jpeg', title: '', description: "", category: 'workshops' },
  { src: 'imgs/FlnUpdate25-8-26/WhatsApp Image 2026-08-27 at 15.06.40 (2).jpeg', title: '', description: "", category: 'workshops' },
