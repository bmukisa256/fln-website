    ...
    <div class="container">
        ...
        <div class="row">
            ...
            $events = [
                ...
                ["image" => "imgs/corporatewomen.jpg", "date" => "1st JUNE 2024|5:00 pm", "name" => "Hilder Bahati Sabiti"],
                ["image" => "imgs/essential.png", "date" => "16th JUNE 2024|4:00 pm", "name" => "Ivan Baguma"],
                ["image" => "imgs/personal fina.jpg", "date" => "7th JULY 2024|4:00 pm", "name" => "Angelina Ofwono"],
                ["image" => "imgs/pp.jpg", "date" => "21st JULY 2024|6:00 pm", "name" => "Dr. Joyce Birimumaaso"],
                ["image" => "imgs/journey.jpg", "date" => "22nd SEPTEMBER 2024|4:00 pm", "name" => "Penelope Sanyu"],
                ["image" => "imgs/century female.jpg", "date" => "13th OCTOBER 2024|4:00 pm", "name" => "Daisy Mulamuzi Kasujja"],
                ["image" => "imgs/dynamic.jpg", "date" => "27th OCTOBER 2024|4:00 pm", "name" => "Fatuma Omar"],
                ["image" => "imgs/goodcommun.jpg", "date" => "3rd NOVEMBER 2024|6:00 pm", "name" => "Norah Matovu Muwanga"],
